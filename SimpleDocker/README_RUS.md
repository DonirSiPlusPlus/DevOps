...
В качестве результата работы быть предоставлен отчет по выполненным задачам в папке src

**Docker** контейнер – новый "исполняемый файл", включающий в себя все необходимые продукту зависимости. \
